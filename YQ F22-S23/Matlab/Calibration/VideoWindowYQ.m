...
classdef VideoWindowYQ  < handle
    ...
    methods
        function obj=VideoWindowYQ(file, hide, varargin)
            ...
            figPos=[800 430]; % 3-inch tall = 430px. change the righter number to 180 for 1-inch tall.
            ...
            if hide
                ...
                % line 44)
                obj.Fig=figure('MenuBar','none','position',[400 300 figPos],... 
