...
% log file
logFilePath = "PAD_logfiles_0331/20230331_150710p20.log"; % change here to your log file path
...
recordFilePath = "PAD_watchrecords_0331/watchRecord_p20_2023-3-31.txt"; % change here to your record file path
...
for i=1:height(watchRecord)
    ...
    sT = watchRecord(i, 12:18);
    sT = sT{1,:};
    sT_padded = sT;
    eT = watchRecord(i, 19:25);
    eT = eT{1,:};
    eT_padded = eT;
    ...
    if (startRow + 1 < endRow)
        ...
        info_line = vidNameNoExtension(1) + "," + trialNumber + "," + (watchRecord{i, 3}) + "," + (watchRecord{i, 4}) + "," + (watchRecord{i, 5}) + "," + (watchRecord{i, 6}) + "," + (watchRecord{i, 7}) + "," + (watchRecord{i, 8}) + "," + (watchRecord{i, 9}) + "," + (watchRecord{i, 10}) + "," + (watchRecord{i, 11}) + "\n";
